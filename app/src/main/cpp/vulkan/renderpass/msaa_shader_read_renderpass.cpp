#include "msaa_shader_read_renderpass.h"
#include "../vulkan_utility.h"

namespace Vulkan
{
    void MSAAShaderReadRenderPass::CreateRenderPassImpl()
    {
...
//    class MSAAShaderReadRenderPass : public MSAARenderPass
//    {
//    public:
//        MSAAShaderReadRenderPass(const Device& device) : MSAARenderPass(device) {}
//        MSAAShaderReadRenderPassverride
//        {
