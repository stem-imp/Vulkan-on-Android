...
//{
//    // Create shader stage.
//    VkShaderModule vertexShader = LoadShaderFromFile("shaders/phong_shading.vert.spv", app, deviceInfo);
//    VkShaderModule fragmentShader = LoadShaderFromFile("shaders/phong_shading.frag.spv", app, deviceInfo);
